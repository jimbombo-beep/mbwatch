...
public class FXSettings implements Initializable {
	...
	@FXML private CheckBox chkShow24;
	@FXML private CheckBox chkShowDate;
	@FXML private CheckBox chkShowMinutes;
	@FXML private ColorPicker colorP24Label;
	@FXML private ColorPicker colorPMinuteLabel;
	...
	public void updateContents() {
		...
		chkShow24.setSelected(_conf.getShow24());
		chkShowDate.setSelected(_conf.getShowDate());
		chkShowMinutes.setSelected(_conf.getShowMinutes());
		colorP24Label.setValue(_conf.get24LabelColor());
		colorPMinuteLabel.setValue(_conf.getMinuteLabelColor());
	...
	private void _apply() {
		try {
			...
			_conf.set24LabelColor(colorP24Label.getValue());
			...
			_conf.setMinuteLabelColor(colorPMinuteLabel.getValue());
			_conf.setNumbering(cbNumbering.getValue());
			_conf.setShow24(chkShow24.isSelected());
			_conf.setShowDate(chkShowDate.isSelected());
			_conf.setShowMinutes(chkShowMinutes.isSelected());
