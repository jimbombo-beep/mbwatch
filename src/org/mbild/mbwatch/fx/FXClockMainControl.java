...
import org.mbild.mbwatch.RTClock;
...
/**
 * Controller for the clock's graphics and control elements.
 * 
 * @author Matthias Bild
 *
 */
public class FXClockMainControl implements EventHandler<Event>, Initializable {
	/**
	 * FXML template path.
	 */
	public static final String TPL = "FXClockMainControl.fxml";
	
	// private fields
	private Configuration _config;
	private FXDigitalClock _digClock;
	private Stage _owner;
	private RTClock _watch;
